...
public:
    ...
    string invokeGetHtml(const string &method, const JsonMap &contentMap, const StringMap &extendParamMap = StringMap());
    StringMap getNotifyResponse(const string &responseBody); 
...
private:
    ...
    string analyzeResponse(const string &responseBody);
    string getResponseBody(const string &responseStr);
    string getHtmlurl(const string &responseStr);
    string urlDecode(const std::string& str);
    StringMap parseNotifyParams(const std::string& responseBody);
